...
/**
 * Repository Grid Window Manager
 */
class RepositoryGridWindowManager {
  constructor() {
    this.window = null;
  }

  /**
   * Create the repository grid window
  ...
  create(options = {}) {
    ...
    this.window.loadFile('src/renderer/repository-grid.html');
  ...
  /**
   * Open the repository grid window (create if doesn't exist)
   * @param {Object} options - Window creation options
  ...
  /**
   * Close the repository grid window
   *
...
module.exports = RepositoryGridWindowManager;